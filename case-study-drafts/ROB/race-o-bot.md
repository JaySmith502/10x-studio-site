...
clientUrl: "<<< FILL IN: public URL if one exists, otherwise delete this line >>>"
...
heroQuote: "<<< FILL IN: a sharp one-line quote from Don, the broadcaster - pulled from a text, voice memo, or live-mic moment on Derby morning. The thesis-as-hero variant needs this to land. >>>"
heroQuoteAttribution: "Don <<< FILL IN: last name + on-air title >>>, racing broadcaster"
metrics:
  - value: "+10.9%"
...
On Derby weekend the broadcaster had a printed PDF of bot picks for both Oaks and Derby - picks he could defend on air because each one came with the same reasoning the dashboard displayed and the voice agent read. The PDF is archived at `archive/2026-derby-weekend/picks/` as the authoritative artifact for what was distributed.
...
<!-- ============================================================
     ...
     and move this file to: site/src/content/case-studies/race-o-bot.md
     ============================================================ -->
