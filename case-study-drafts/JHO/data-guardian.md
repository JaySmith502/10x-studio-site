...
<<< FILL IN: one or two specific operational pains in the client's own words - e.g., a customer complaint that landed because a product page had no image, a vendor sync that broke a category for a weekend. The buyer needs to feel the cost of the before-state. >>>
...
<<< FILL IN: the before/after the buyer needs to see. Specific beats are better than percentages here unless you have hard numbers. Example shapes: "What used to be a Saturday of spreadsheet work is now a Tuesday-morning queue triage." / "A vendor onboarding that took a week now takes the time to answer the unknown-data queue." / "The operator stopped being the bottleneck for the catalog and started being the editor of it." If you have a real number on time saved, error-rate reduction, or vendor onboarding speed, drop it here with honest framing. >>>
...
<<< FILL IN: optional - a line about what's next on the roadmap or what you'd build differently if you started today. Keep it honest; this is the trust signal. >>>

---

<!-- ============================================================
     PLACEHOLDER CHECKLIST
     - One or two specific before-state pains (THE BRIEF)
     - The before/after operational change (WHAT IT CHANGED)
     - Optional v2 / what's next line (WHAT WE'D STILL TELL YOU)
     Before publishing:
       - Confirm every <<< FILL IN >>> is resolved
       - Strip any reference to the real client name, operator name, or GitHub handle
       - Flip frontmatter `draft: true` → `draft: false`
       - Copy to: site/src/content/case-studies/data-guardian.md
     ============================================================ -->
