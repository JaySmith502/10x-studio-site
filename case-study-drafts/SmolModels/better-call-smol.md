...
client: "Better Call Smol (Jay Smith)"
clientUrl: "<<< FILL IN: public URL once live - currently a Netlify deploy preview >>>"
industry: "AI tooling / developer education"
pubDate: 2026-06-07
role: "Founder & engineer"
variant: "B"
color: "blue"
duration: "<<< FILL IN: e.g. '2 weeks of build, May 2026' - confirm against your own time, repo shows 33 commits across May 8–14 >>>"
...
<<< FILL IN: The before/after. The project is pre-launch as of this writing - v1 targets a July 2026 talk demo per the roadmap. Until there's real usage data, this section should be qualitative: what changes for a buyer who lands on the site, runs three prompts through the bot, and sees the recommendation isn't "use our API." If you have early demo-day or pilot feedback by publication, swap it in here. >>>
